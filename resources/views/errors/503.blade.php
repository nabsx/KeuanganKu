...
<body class="bg-background text-text-primary">
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-lg w-full text-center">
            ...
            <!-- 503 Number -->
            <div class="mb-6">
                <h1 class="text-9xl font-bold text-warning mb-2">503</h1>
                <div class="h-1 w-24 bg-warning mx-auto mb-4"></div>
            </div>

            <!-- Error Message -->
            <div class="mb-8">
                <h2 class="text-3xl font-bold mb-3">Layanan Tidak Tersedia</h2>
                <p class="text-text-secondary text-lg">
                    Server kami sedang dalam pemeliharaan atau mengalami beban yang tinggi. Silakan coba lagi dalam beberapa saat.
                </p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ route('home') }}" class="px-6 py-3 bg-warning text-black font-semibold rounded-lg hover:bg-warning-dark transition">
                    Ke Landing Page
                </a>
            </div>
