...
<body class="bg-background text-text-primary">
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-lg w-full text-center">
            ...
            <!-- 500 Number -->
            <div class="mb-6">
                <h1 class="text-9xl font-bold text-error mb-2">500</h1>
                <div class="h-1 w-24 bg-error mx-auto mb-4"></div>
            </div>

            <!-- Error Message -->
            <div class="mb-8">
                <h2 class="text-3xl font-bold mb-3">Kesalahan Server Internal</h2>
                <p class="text-text-secondary text-lg">
                    Terjadi kesalahan tidak terduga pada server kami. Tim kami telah diberitahu tentang masalah ini dan sedang mengatasinya.
                </p>
            </div>

            <!-- Illustration -->
            <div class="mb-8 p-8 bg-surface-secondary rounded-2xl border border-border-light">
                <svg class="w-24 h-24 mx-auto text-error opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v2m0 4v2m0 0v2m6-6a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
            </div>
