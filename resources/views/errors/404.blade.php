...
<body class="bg-background text-text-primary">
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-lg w-full text-center">
            ...
            <!-- 404 Number -->
            <div class="mb-6">
                <h1 class="text-9xl font-bold text-accent mb-2">404</h1>
                <div class="h-1 w-24 bg-accent mx-auto mb-4"></div>
            </div>

            <!-- Error Message -->
            <div class="mb-8">
                <h2 class="text-3xl font-bold mb-3">Halaman Tidak Ditemukan</h2>
                <p class="text-text-secondary text-lg">
                    Maaf, halaman yang Anda cari sepertinya tidak ada. Mungkin halaman telah dihapus atau URL yang Anda masukkan salah.
                </p>
            </div>
