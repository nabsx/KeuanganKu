...
<div class="flex-1 md:ml-64 w-full flex flex-col">
    ...
    <header class="md:hidden bg-surface-secondary border-b border-border-light sticky top-0 z-10">
        ...
        <nav id="mobileMenu" class="hidden px-4 pb-4 space-y-1 bg-surface border-t border-border-light">
            ...
            <a href="{{ route('data-backup.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition {{ request()->routeIs('data-backup.*') ? 'bg-glass-light text-accent' : 'text-text-secondary hover:bg-glass' }}"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Zm2 4h6m-6 4h6m-6 4h3"/></svg>Data & Backup</a>
